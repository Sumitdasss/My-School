...
export default function Navbar() {
  ...
  const portals = [
    ...
    { name: "Admin Dashboard", href: "/Adminpanel", icon: LayoutDashboard },
  ];
...
useEffect(() => {
  ...
  return (
    ...
    scrolled ? "bg-[#050B14]/50" : "bg-[#050B14]/50"
  ...
  <div className="hidden xl:block relative group/profile">
    <button className="flex items-center gap-3 px-3 py-2 rounded-full bg-white/[0.04] border border-white/10 hover:border-[#D9B65C]/40 transition-colors">
      ...
      <ChevronDown
        size={16}
        className="group-hover/profile:rotate-180 text-white transition-transform"
      />
    </button>
{ role==="student" &&(<>
            ...
            <div key={index} className="border-b border-[#081527]/[0.06] pb-1 last:border-none">
              {item.dropdown ? (
                  ...
                  >
                    {item.dropdown.map((subItem, subIndex) => (
                      <Link
                        ...
                        href={subItem.href}
                        onClick={() => setIsOpen(false)}
                        className="flex items-center space-x-2 px-4 py-2.5 text-sm text-[#b1bdce] rounded-md hover:bg-[#081527]/[0.04] hover:text-[#ecf0f5] transition-colors"
                      >
                ...
                <Link
                  href={item.href}
                  onClick={() => setIsOpen(false)}
                  className="block px-3 py-3.5 text-[15px] font-medium text-[#e2e8f1] rounded-lg hover:bg-[#387ee0]/[0.03] hover:text-[#185fc2] transition-colors"
                >
                  {item.name}
                </Link>
              )}
