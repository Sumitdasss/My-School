...
<div className=" relative">
    <input
      ...
      className="w-full border border-gray-300 rounded-xl p-3.5 mb-4 outline-none focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 transition-all duration-200 text-gray-800 placeholder:text-gray-400"
    />
